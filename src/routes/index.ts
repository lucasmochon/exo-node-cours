...
import tournamentContoller from '../controller/index';

const router = express.Router();

router.get("/", (req, res) => tournamentContoller.getAll(req, res));
router.get("/:id", (req, res) => tournamentContoller.getById(req, res));
router.post("/", (req, res) => tournamentContoller.create(req, res));
